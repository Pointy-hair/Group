...
XML File: C:\src\traffk\HealthInformationPortal\src\Traffk.Bal\Data\Rdb\Rdb.Meta.xml
Generation Time: 04/01/2017 13:53:42
*/
...
namespace Traffk.Bal.Data.Rdb
{
    public partial class TraffkRdbContext
    {
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Contact>()
				...
				.HasValue<Carrier>("Carrier")
				.HasValue<Organization>("Organization")
				.HasValue<Person>("Person")
				.HasValue<Provider>("Provider")
		...
		public DbSet<Application> Applications { get; set; } //dbo.Applications
		...
		public DbSet<Country> Countries { get; set; } //dbo.Countries

		
		public DbSet<Creative> Creatives { get; set; } //dbo.Creatives

		
		public DbSet<CustomInsurancePlanEconomic> CustomInsurancePlanEconomics { get; set; } //dbo.CustomInsurancePlanEconomics

		
		public DbSet<CustomInsurancePlan> CustomInsurancePlans { get; set; } //dbo.CustomInsurancePlans

		
		public DbSet<DateDimension> DateDimensions { get; set; } //dbo.DateDimensions

		
		public DbSet<InsurancePlan> InsurancePlans { get; set; } //dbo.InsurancePlans

		
		public DbSet<Job> Jobs { get; set; } //dbo.Jobs
		...
		public DbSet<ReportMetaData> ReportMetaData { get; set; } //dbo.ReportMetaData

		
		public DbSet<Tenant> Tenants { get; set; } //dbo.Tenants

		
		public DbSet<UserActivity> UserActivities { get; set; } //dbo.UserActivities

		
		public DbSet<CareAlert> CareAlerts { get; set; } //deerwalk.CareAlerts

		
		public DbSet<Demographic> Demographics { get; set; } //deerwalk.Demographics

		
		public DbSet<Eligibility> Eligibility { get; set; } //deerwalk.Eligibility

		
		public DbSet<HighCostDiagnosi> HighCostDiagnosis { get; set; } //deerwalk.HighCostDiagnosis

		
		public DbSet<HistoricalScore> HistoricalScores { get; set; } //deerwalk.HistoricalScores

		
		public DbSet<MedicalClaim> MedicalClaims { get; set; } //deerwalk.MedicalClaims

		
		public DbSet<MemberPCP> MemberPCP { get; set; } //deerwalk.MemberPCP

		
		public DbSet<Participation> Participation { get; set; } //deerwalk.Participation

		
		public DbSet<Pharmacy> Pharmacy { get; set; } //deerwalk.Pharmacy

		
		public DbSet<QualityMetric> QualityMetrics { get; set; } //deerwalk.QualityMetrics

		
		public DbSet<Score> Scores { get; set; } //deerwalk.Scores

		
		public DbSet<Visit> Visits { get; set; } //deerwalk.Visits
	...
	public partial class Address : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IPrimaryKey<int>
	{
		...
		public virtual void Validate()
        {
			Requires.Text(Address1, nameof(Address1), true, 0, 255);
			Requires.Text(Address2, nameof(Address2), true, 0, 255);
	...
	public partial class Application : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IPrimaryKey<int>
	{
        public static readonly Application[] None = new Application[0];

		object IPrimaryKey.Key { get { return ApplicationId; }}
	
		int IPrimaryKey<int>.Key { get { return ApplicationId; }}
		...
		public Application(Application other, bool copyKey=false)
		{
			if (other!=null)
			{
							if (copyKey)
	...
	public abstract partial class Contact : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IPrimaryKey<long>
	{
        public static readonly Contact[] None = new Contact[0];

		//skipped: health.Pharmacy

		//skipped: health.Pharmacy

		//skipped: health.MillimanScores

		[InverseProperty("OwnerContact")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<ReportMetaData> OwnerContactReportMetaDatas { get; set; } = new List<ReportMetaData>();
		...
		//skipped: health.Participation

		//skipped: health.Eligibility

		//skipped: health.Visits

		//skipped: dbo.AspNetUsers

		//skipped: health.MedicalClaims

		//skipped: health.MedicalClaimLines

		//skipped: health.Members

		//skipped: health.Members

		object IPrimaryKey.Key { get { return ContactId; }}
	
		long IPrimaryKey<long>.Key { get { return ContactId; }}
		...
		public Contact(Contact other, bool copyKey=false)
		{
			if (other!=null)
			{
				...
				OwnerContactReportMetaDatas = other.OwnerContactReportMetaDatas;
		...
		public virtual void Validate()
        {
			...
			Requires.Text(CarrierId, nameof(CarrierId), true, 0, 50);
			PartialValidate();
        }
	}
	...
	{
        public static new readonly Carrier[] None = new Carrier[0];
		...
		public Carrier(Carrier other, bool copyKey=false)
			: base(other)
		{
			if (other!=null)
			{
	...
	public partial class Organization : Contact
	{
		...
		public Organization(Organization other, bool copyKey=false)
			: base(other)
		{
			if (other!=null)
			{
	...
	public partial class Person : Contact
	{
		...
		public Person(Person other, bool copyKey=false)
			: base(other)
		{
			if (other!=null)
			{
	...
	[Table("Contacts", Schema = "dbo")]
	public partial class Provider : Contact
	{
        public static new readonly Provider[] None = new Provider[0];
		...
		public Provider(Provider other, bool copyKey=false)
			: base(other)
		{
			if (other!=null)
			{
        ...
        {
			base.Validate();
			Requires.Text(ProviderId, nameof(ProviderId), true, 0, 50);
			PartialValidate();
        }
	}
	...
	public partial class Country : IRdbDataEntity, IValidate, IPreSave, IDontCreate, IPrimaryKey<int>
	{
		...
		[JsonIgnore]
        [IgnoreDataMember]
        public List<Address> CountryAddresss { get; set; } = new List<Address>();
		...
		public Country(Country other, bool copyKey=false)
		{
			if (other!=null)
			{
				...
				CountryAddresss = other.CountryAddresss;
	...
	[Table("CustomInsurancePlanEconomics", Schema = "dbo")]
	public partial class CustomInsurancePlanEconomic : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IPrimaryKey<int>
	{
        public static readonly CustomInsurancePlanEconomic[] None = new CustomInsurancePlanEconomic[0];

		object IPrimaryKey.Key { get { return CustomInsurancePlanEconomicId; }}
	
		int IPrimaryKey<int>.Key { get { return CustomInsurancePlanEconomicId; }}

		[DisplayName("Custom Insurance Plan Economic Id")]
		[Key]
		[DatabaseGenerated(DatabaseGeneratedOption.Identity)]
		[Column("CustomInsurancePlanEconomicId")]
		public int CustomInsurancePlanEconomicId { get; set; }
		...
		[DisplayName("Custom Insurance Plan Id")]
		[Column("CustomInsurancePlanId")]
		public int CustomInsurancePlanId { get; set; }

		[ForeignKey("CustomInsurancePlanId")]
		[JsonIgnore]
        [IgnoreDataMember]
		public CustomInsurancePlan CustomInsurancePlan { get; set; }
		...
		[DisplayName("Period Start Ddim")]
		[Column("PeriodStartDdim")]
		public int PeriodStartDdim { get; set; }

		[ForeignKey("PeriodStartDdim")]
		[JsonIgnore]
        [IgnoreDataMember]
		public DateDimension PeriodStartDd { get; set; }

		[DisplayName("Period End Ddim")]
		[Column("PeriodEndDdim")]
		public int PeriodEndDdim { get; set; }

		[ForeignKey("PeriodEndDdim")]
		[JsonIgnore]
        [IgnoreDataMember]
		public DateDimension PeriodEndDd { get; set; }
        ...
        public override string ToString()
		{
			string extras = null;
			OnToString(ref extras);
			return $"{GetType().Name} CustomInsurancePlanEconomicId={CustomInsurancePlanEconomicId} {extras}";
		}

		partial void OnConstructed();
	
		public CustomInsurancePlanEconomic()
			: this(null)
		{}

		public CustomInsurancePlanEconomic(CustomInsurancePlanEconomic other, bool copyKey=false)
		{
			if (other!=null)
			{
							if (copyKey)
				{
					CustomInsurancePlanEconomicId = other.CustomInsurancePlanEconomicId;
				}
				TenantId = other.TenantId;
				CustomInsurancePlanId = other.CustomInsurancePlanId;
				CostType = other.CostType;
				FeeType = other.FeeType;
				PeriodStartDdim = other.PeriodStartDdim;
				PeriodEndDdim = other.PeriodEndDdim;
				Amount = other.Amount;
			}
			OnConstructed();
		}
		...
		public virtual void Validate()
        {
			Requires.NonNull(CostType, nameof(CostType));
			Requires.Text(CostType, nameof(CostType), true, 0, 80);
			Requires.NonNull(FeeType, nameof(FeeType));
			Requires.Text(FeeType, nameof(FeeType), true, 0, 80);
			PartialValidate();
        }
	}

	[Table("CustomInsurancePlans", Schema = "dbo")]
	public partial class CustomInsurancePlan : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IPrimaryKey<int>
	{
        public static readonly CustomInsurancePlan[] None = new CustomInsurancePlan[0];

		[InverseProperty("CustomInsurancePlan")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<Eligibility> CustomInsurancePlanEligibilitys { get; set; } = new List<Eligibility>();

		[InverseProperty("CustomInsurancePlan")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<Pharmacy> CustomInsurancePlanPharmacys { get; set; } = new List<Pharmacy>();

		[InverseProperty("CustomInsurancePlan")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<MedicalClaim> CustomInsurancePlanMedicalClaims { get; set; } = new List<MedicalClaim>();

		[InverseProperty("CustomInsurancePlan")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<CustomInsurancePlanEconomic> CustomInsurancePlanCustomInsurancePlanEconomics { get; set; } = new List<CustomInsurancePlanEconomic>();

		object IPrimaryKey.Key { get { return CustomInsurancePlanId; }}
	
		int IPrimaryKey<int>.Key { get { return CustomInsurancePlanId; }}
		...
		[DisplayName("Custom Insurance Plan Code")]
		[MaxLength(100)]
		[Column("CustomInsurancePlanCode")]
		public string CustomInsurancePlanCode { get; set; }

		[DisplayName("Custom Insurance Plan Description")]
		[Column("CustomInsurancePlanDescription")]
		public string CustomInsurancePlanDescription { get; set; }
        ...
        public override string ToString()
		{
			string extras = null;
			OnToString(ref extras);
			return $"{GetType().Name} CustomInsurancePlanId={CustomInsurancePlanId} {extras}";
		}

		partial void OnConstructed();
	
		public CustomInsurancePlan()
			: this(null)
		{}

		public CustomInsurancePlan(CustomInsurancePlan other, bool copyKey=false)
		{
			if (other!=null)
			{
							if (copyKey)
				...
				CustomInsurancePlanEligibilitys = other.CustomInsurancePlanEligibilitys;
				CustomInsurancePlanPharmacys = other.CustomInsurancePlanPharmacys;
				CustomInsurancePlanMedicalClaims = other.CustomInsurancePlanMedicalClaims;
				CustomInsurancePlanCustomInsurancePlanEconomics = other.CustomInsurancePlanCustomInsurancePlanEconomics;
				TenantId = other.TenantId;
				InsurancePlanId = other.InsurancePlanId;
				CustomInsurancePlanCode = other.CustomInsurancePlanCode;
				CustomInsurancePlanDescription = other.CustomInsurancePlanDescription;
			}
			OnConstructed();
		}
		...
		public virtual void Validate()
        {
			Requires.Text(CustomInsurancePlanCode, nameof(CustomInsurancePlanCode), true, 0, 100);
			PartialValidate();
        }
	}
	...
	public partial class DateDimension : IRdbDataEntity, IValidate, IPreSave, IPrimaryKey<int>
	{
		...
		[InverseProperty("PeriodStartDd")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<CustomInsurancePlanEconomic> PeriodStartDdCustomInsurancePlanEconomics { get; set; } = new List<CustomInsurancePlanEconomic>();

		[InverseProperty("PeriodEndDd")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<CustomInsurancePlanEconomic> PeriodEndDdCustomInsurancePlanEconomics { get; set; } = new List<CustomInsurancePlanEconomic>();
		...
		public DateDimension(DateDimension other, bool copyKey=false)
		{
			if (other!=null)
			{
				...
				PeriodStartDdCustomInsurancePlanEconomics = other.PeriodStartDdCustomInsurancePlanEconomics;
				PeriodEndDdCustomInsurancePlanEconomics = other.PeriodEndDdCustomInsurancePlanEconomics;
	...
	[Table("InsurancePlans", Schema = "dbo")]
	public partial class InsurancePlan : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IPrimaryKey<int>
	{
		...
		[InverseProperty("InsurancePlan")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<CustomInsurancePlan> InsurancePlanCustomInsurancePlans { get; set; } = new List<CustomInsurancePlan>();
		...
		public long InsuranceCarrierContactId { get; set; }
		...
		public InsurancePlan(InsurancePlan other, bool copyKey=false)
		{
			if (other!=null)
			{
				...
				InsurancePlanCustomInsurancePlans = other.InsurancePlanCustomInsurancePlans;
				TenantId = other.TenantId;
	...
	public partial class Lookup : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IPrimaryKey<int>
	{
		...
		[DisplayName("Lookup Row Status")]
		[Column("LookupRowStatus")]
		public char LookupRowStatus { get; set; }
		...
		public Lookup(Lookup other, bool copyKey=false)
		{
			if (other!=null)
			{
				...
				TenantId = other.TenantId;
				LookupRowStatus = other.LookupRowStatus;
	...
	[Table("ReportMetaData", Schema = "dbo")]
	public partial class ReportMetaData : IRdbDataEntity, IValidate, IPreSave, IPrimaryKey<int>
	{
        ...
        [NotMapped]
        public Bal.ReportVisuals.ReportDetails ReportDetails
        {
            get
            {
                if (ReportDetails_p == null)
                {
                    ReportDetails_p = Bal.ReportVisuals.ReportDetails.CreateFromJson(ReportDetailsJson) ?? new Bal.ReportVisuals.ReportDetails();
        ...
        private Bal.ReportVisuals.ReportDetails ReportDetails_p;
	...
	public partial class Tenant : IRdbDataEntity, IValidate, IPreSave, IPrimaryKey<int>
	{
		...
		[JsonIgnore]
        [IgnoreDataMember]
        public List<ReportMetaData> TenantReportMetaDatas { get; set; } = new List<ReportMetaData>();
		...
		[JsonIgnore]
        [IgnoreDataMember]
        public List<CustomInsurancePlan> TenantCustomInsurancePlans { get; set; } = new List<CustomInsurancePlan>();
		...
		[JsonIgnore]
        [IgnoreDataMember]
        public List<CustomInsurancePlanEconomic> TenantCustomInsurancePlanEconomics { get; set; } = new List<CustomInsurancePlanEconomic>();
		...
		//skipped: health.MedicalClaimDiagnoses
		...
		public Tenant(Tenant other, bool copyKey=false)
		{
			if (other!=null)
			{
				...
				TenantReportMetaDatas = other.TenantReportMetaDatas;
				...
				TenantCustomInsurancePlans = other.TenantCustomInsurancePlans;
				...
				TenantCustomInsurancePlanEconomics = other.TenantCustomInsurancePlanEconomics;
	...
	public partial class UserActivity : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IPrimaryKey<int>
	{
        public static readonly UserActivity[] None = new UserActivity[0];

		object IPrimaryKey.Key { get { return UserActivityId; }}
	
		int IPrimaryKey<int>.Key { get { return UserActivityId; }}
		...
		public UserActivity(UserActivity other, bool copyKey=false)
		{
			if (other!=null)
			{
							if (copyKey)
	...
	public partial class CareAlert : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IDontCreate, IPrimaryKey<long>
	{
        public static readonly CareAlert[] None = new CareAlert[0];

		object IPrimaryKey.Key { get { return CareAlertId; }}
	
		long IPrimaryKey<long>.Key { get { return CareAlertId; }}
	...
	public partial class Demographic : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IDontCreate, IPrimaryKey<long>
	{
        public static readonly Demographic[] None = new Demographic[0];

		object IPrimaryKey.Key { get { return DemographicId; }}
	
		long IPrimaryKey<long>.Key { get { return DemographicId; }}
		...
		public Demographic(Demographic other, bool copyKey=false)
		{
			if (other!=null)
			{
							if (copyKey)
	...
	public partial class Eligibility : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IDontCreate, IPrimaryKey<long>
	{
        public static readonly Eligibility[] None = new Eligibility[0];

		object IPrimaryKey.Key { get { return EligibilityId; }}
	
		long IPrimaryKey<long>.Key { get { return EligibilityId; }}
	...
	public partial class HighCostDiagnosi : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IDontCreate, IPrimaryKey<long>
	{
        public static readonly HighCostDiagnosi[] None = new HighCostDiagnosi[0];

		object IPrimaryKey.Key { get { return HighCostDiagnosisId; }}
	
		long IPrimaryKey<long>.Key { get { return HighCostDiagnosisId; }}
		...
		public HighCostDiagnosi(HighCostDiagnosi other, bool copyKey=false)
		{
			if (other!=null)
			{
							if (copyKey)
				{
					HighCostDiagnosisId = other.HighCostDiagnosisId;
				}
				TenantId = other.TenantId;
				ContactId = other.ContactId;
				dw_record_id = other.dw_record_id;
	...
	public partial class HistoricalScore : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IDontCreate, IPrimaryKey<long>
	{
        public static readonly HistoricalScore[] None = new HistoricalScore[0];

		object IPrimaryKey.Key { get { return HistoricalScoreId; }}
	
		long IPrimaryKey<long>.Key { get { return HistoricalScoreId; }}
		...
		public HistoricalScore(HistoricalScore other, bool copyKey=false)
		{
			if (other!=null)
			{
							if (copyKey)
				{
					HistoricalScoreId = other.HistoricalScoreId;
				}
				TenantId = other.TenantId;
				ContactId = other.ContactId;
				dw_record_id = other.dw_record_id;
	...
	public partial class MedicalClaim : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IDontCreate, IPrimaryKey<long>
	{
        public static readonly MedicalClaim[] None = new MedicalClaim[0];

		object IPrimaryKey.Key { get { return MedicalClaimId; }}
	
		long IPrimaryKey<long>.Key { get { return MedicalClaimId; }}
		...
		public string rev_claim_type_flag { get; set; }
		...
		public string prv_in_network_flag { get; set; }
	...
	public partial class MemberPCP : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IDontCreate, IPrimaryKey<long>
	{
        public static readonly MemberPCP[] None = new MemberPCP[0];

		object IPrimaryKey.Key { get { return MemberPcpId; }}
	
		long IPrimaryKey<long>.Key { get { return MemberPcpId; }}
		...
		public MemberPCP(MemberPCP other, bool copyKey=false)
		{
			if (other!=null)
			{
							if (copyKey)
				{
					MemberPcpId = other.MemberPcpId;
				}
				TenantId = other.TenantId;
				ContactId = other.ContactId;
				dw_record_id = other.dw_record_id;
	...
	public partial class Participation : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IDontCreate, IPrimaryKey<long>
	{
        public static readonly Participation[] None = new Participation[0];

		object IPrimaryKey.Key { get { return ParticipationId; }}
	
		long IPrimaryKey<long>.Key { get { return ParticipationId; }}
	...
	public partial class Pharmacy : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IDontCreate, IPrimaryKey<long>
	{
        public static readonly Pharmacy[] None = new Pharmacy[0];

		object IPrimaryKey.Key { get { return PharmacyId; }}
	
		long IPrimaryKey<long>.Key { get { return PharmacyId; }}
	...
	public partial class QualityMetric : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IDontCreate, IPrimaryKey<long>
	{
        public static readonly QualityMetric[] None = new QualityMetric[0];

		object IPrimaryKey.Key { get { return QualityMetricId; }}
	
		long IPrimaryKey<long>.Key { get { return QualityMetricId; }}
	...
	public partial class Score : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IDontCreate, IPrimaryKey<long>
	{
        public static readonly Score[] None = new Score[0];

		object IPrimaryKey.Key { get { return ScoreId; }}
	
		long IPrimaryKey<long>.Key { get { return ScoreId; }}
		...
		public Score(Score other, bool copyKey=false)
		{
			if (other!=null)
			{
							if (copyKey)
	...
	public partial class Visit : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IDontCreate, IPrimaryKey<long>
	{
        public static readonly Visit[] None = new Visit[0];

		object IPrimaryKey.Key { get { return VisitId; }}
	
		long IPrimaryKey<long>.Key { get { return VisitId; }}
