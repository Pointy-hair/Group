...
XML File: C:\Users\Darren\Source\Repos\HealthInformationPortal\src\Traffk.Bal\Data\Rdb\Rdb.Meta.xml
Generation Time: 03/20/2017 17:21:33
*/
...
namespace Traffk.Bal.Data.Rdb
{
	...
	public partial class Address : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
	...
	public abstract partial class Contact : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
	...
	public partial class CustomInsurancePlanEconomic : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
	...
	public partial class CustomInsurancePlan : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
	...
	public partial class InsurancePlan : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
	...
	public partial class Lookup : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
	...
	public partial class ReportMetaData : IRdbDataEntity, IValidate, IPreSave
	{
		...
		partial void OnMetaDataDeserialized();

        [NotMapped]
        public Bal.ReportVisuals.ReportMetaData MetaData
        {
            get
            {
                if (MetaData_p == null)
                {
                    MetaData_p = Bal.ReportVisuals.ReportMetaData.CreateFromJson(MetaDataJson) ?? new Bal.ReportVisuals.ReportMetaData();
					OnMetaDataDeserialized();
                }
                return MetaData_p;
            }
            set { MetaData_p = value; }
        }
        private Bal.ReportVisuals.ReportMetaData MetaData_p;
		...
		protected virtual void OnPreSave()
		{
            if (MetaData_p != null)
            {
				var json = MetaData_p.ToJson();
				if (MetaDataJson != json)
				{
					MetaDataJson = json;
				}				 
            }
		...
		public virtual void Validate()
        {
			...
			Requires.NonNull(MetaDataJson, nameof(MetaDataJson));
			PartialValidate();
        }
	}
