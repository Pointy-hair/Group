...
namespace Traffk.Bal.Data.Rdb.TraffkTenantModel
{
	...
	public partial class HealthcareCommonProcedureCodingSystemCode : IRdbDataEntity, IValidate, IPreSave, IPrimaryKey<int>
	{
		...
		//modelBuilder.Entity<MedicalClaimLine>(e=>e.HasOne(r=>r.ProcedureHcpcs).WithMany(u=>u.ProcedureHcpcsMedicalClaimLines).HasForeignKey(r=>r.ProcedureHcpcsId));
	...
	public partial class Tenant : IRdbDataEntity, IValidate, IPreSave, IPrimaryKey<int>
	{
		...
		//modelBuilder.Entity<MedicalClaimDiagnose>(e=>e.HasOne(r=>r.Tenant).WithMany(u=>u.TenantMedicalClaimDiagnoses).HasForeignKey(r=>r.TenantId));
		[InverseProperty("Tenant")]
		[JsonIgnore]
        [IgnoreDataMember]
	...
	public partial class MedicalClaimDiagnose : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IDontCreate, IPrimaryKey<int>
	{
		...
		[Display(Name = "Medical Claim Diagnosis Id")]
		[Key]
		[DatabaseGenerated(DatabaseGeneratedOption.Identity)]
	...
	}//end of entity class MedicalClaimDiagnose
	...
	public partial class MedicalClaimLine : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IDontCreate, IPrimaryKey<int>
	{
		...
		[Display(Name = "Procedure Hcpcs Id")]
	...
	public partial class MedicalClaim : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IDontCreate, IPrimaryKey<int>
	{
		...
		//modelBuilder.Entity<MedicalClaimDiagnose>(e=>e.HasOne(r=>r.MedicalClaim).WithMany(u=>u.MedicalClaimMedicalClaimDiagnoses).HasForeignKey(r=>r.MedicalClaimId));
	...
	public partial class Pharmacy : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IDontCreate, IPrimaryKey<int>
	{
		...
		[Display(Name = "National Drug Code Package Id")]
	...
	public partial class ICD10 : IRdbDataEntity, IValidate, IPreSave, IPrimaryKey<int>
	{
		...
		//modelBuilder.Entity<MedicalClaimDiagnose>(e=>e.HasOne(r=>r.Icd10).WithMany(u=>u.Icd10MedicalClaimDiagnoses).HasForeignKey(r=>r.Icd10Id));
	...
	public partial class Package : IRdbDataEntity, IValidate, IPreSave, IDontCreate, IPrimaryKey<int>
	{
		...
		//modelBuilder.Entity<Pharmacy>(e=>e.HasOne(r=>r.NationalDrugCodePackage).WithMany(u=>u.NationalDrugCodePackagePharmacys).HasForeignKey(r=>r.NationalDrugCodePackageId));
