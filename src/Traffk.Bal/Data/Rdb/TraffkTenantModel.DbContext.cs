...
Generation Time: 09/17/2017 15:50:21
*/
...
namespace Traffk.Bal.Data.Rdb.TraffkTenantModel
{
	...
	public partial class InsurancePlan : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted, IPrimaryKey<int>
	{
		...
		[DisplayName("Insurance Plan Details")]
		[Display(Name = "Insurance Plan Details")]
		[Column("InsurancePlanDetails")]
		...
		public InsurancePlan(InsurancePlan other, bool copyKey=false)
		{
			if (other!=null)
			{
				...
				InsurancePlanDetails = other.InsurancePlanDetails;
			}
			OnConstructed();
		}
