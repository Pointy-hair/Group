...
Generation Time: 06/06/2017 16:49:59
*/
...
namespace Traffk.Bal.Data.Rdb.TraffkGlobal
{
    public partial class TraffkGlobalDbContext
    {
		...
		public DbSet<State> State { get; set; } //HangFire.State
	...
	public partial class Job : IRdbDataEntity, IValidate, IPreSave, IPrimaryKey<int>
	{
		...
		[JsonIgnore]
        [IgnoreDataMember]
        public List<State> JobStates { get; set; } = new List<State>();
	...
	public partial class State : IRdbDataEntity, IValidate, IPreSave, IPrimaryKey<int>
	{
		...
		public State(State other, bool copyKey=false)
		{
			if (other!=null)
			{
				if (copyKey)
		...
		public virtual void Validate()
        {
			...
			Requires.Text(Reason, nameof(Reason), true, 0, 100);
			PartialValidate();
        }
	}
}
