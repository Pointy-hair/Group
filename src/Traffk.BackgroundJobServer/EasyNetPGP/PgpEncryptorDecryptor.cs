...
namespace Traffk.BackgroundJobServer.EasyNetPGP
{
    /// <summary>
    /// Used for Encryption and Decryption of files using PGP.
    /// </summary>
    /// <remarks>https://github.com/davisb10/EasyNetPGP/blob/master/EasyNetPGP/PgpEncryptorDecryptor.cs</remarks>
    public class PgpEncryptorDecryptor
    {
        ...
        public static PgpSecretKeyRingBundle CreatePgpSecretKeyRingBundle(Stream privateKeyFileStream)
            => new PgpSecretKeyRingBundle(PgpUtilities.GetDecoderStream(privateKeyFileStream));
