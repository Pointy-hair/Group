...
namespace Traffk.Tableau.REST.Models
{
    ...
    public class SiteDatasource : SiteDocumentBase, IEditDataConnectionsSet
    {
        ...
        /// </summary>
        private List<SiteConnection> DataConnections_p;
        ...
        public ReadOnlyCollection<SiteConnection> DataConnections
        {
            get
            {
                var dataConnections = DataConnections_p;
        ...
        public SiteDatasource(XmlNode datasourceNode, string xmlNamespace) : base(datasourceNode, xmlNamespace)
        {
        ...
        void IEditDataConnectionsSet.SetDataConnections(IEnumerable<SiteConnection> connections)
        {
            if (connections == null)
            {
                DataConnections_p = null;
            }
            DataConnections_p = new List<SiteConnection>(connections);
        }
    }
}
