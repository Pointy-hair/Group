...
namespace Traffk.CronExpressionDescriptor
{
    public class ExpressionParser
    {
        ...
        public ExpressionParser(string expression, Options options)
        {
            ...
            Options = options;
            Culture = new CultureInfo("en-US"); //Default to English
        }
        ...
        public string[] Parse()
        {
            ...
            {
                string[] expressionPartsTemp = Expression.Split(new[] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
        ...
        private void NormalizeExpression(string[] expressionParts)
        {
            ...
            for (int i = 1; i <= 12; i++)
            {
                ...
                string currentMonthDescription = currentMonth.ToString("MMM", Culture).ToUpperInvariant();
