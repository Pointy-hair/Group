...
create table ISO3166.Countries
(
...
exec db.TablePropertySet  'Countries', 'Country', @propertyName='ClassName', @tableSchema='ISO3166'
exec db.TablePropertySet  'Countries', 'IDontCreate', @propertyName='Implements', @tableSchema='ISO3166'
exec db.TablePropertySet  'Countries', '1', @propertyName='AddToDbContext', @tableSchema='ISO3166'
exec db.TablePropertySet  'Countries', '1', @propertyName='GeneratePoco', @tableSchema='ISO3166'

GO

insert into ISO3166.Countries
