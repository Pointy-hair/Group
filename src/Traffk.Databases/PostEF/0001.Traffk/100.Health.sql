...
(
	...
	ShortTermDisabilityEffDdim int null references DateDimensions(DalinleteDimensionId),
...
exec db.TablePropertySet  'MedicalClaimDiagnoses', '0', @propertyName='AddToDbContext', @tableSchema='health'
exec db.TablePropertySet  'MedicalClaimDiagnoses', '0', @propertyName='GeneratePoco', @tableSchema='health'
...
exec db.TablePropertySet  'Participation', '0', @propertyName='AddToDbContext', @tableSchema='health'
exec db.TablePropertySet  'Participation', '0', @propertyName='GeneratePoco', @tableSchema='health'
