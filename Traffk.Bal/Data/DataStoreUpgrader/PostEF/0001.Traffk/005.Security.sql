...
create SECURITY POLICY Security.dataAccessPolicy
	...
	--add block predicate security.TenantPredicate(TenantId) on dbo.CommunicationPieces,
	add filter predicate security.TenantPredicate(TenantId) on dbo.CommunicationPieces,
	--add block predicate security.TenantPredicate(TenantId) on dbo.CommunicationPieceVisits,
	add filter predicate security.TenantPredicate(TenantId) on dbo.CommunicationPieceVisits,
	--add block predicate security.TenantAndStatusPredicate(TenantId, CommunicationRowStatus) on dbo.Communications,
	add filter predicate security.TenantAndStatusPredicate(TenantId, CommunicationRowStatus) on dbo.Communications,
	--add block predicate security.TenantAndStatusPredicate(TenantId, ContactRowStatus) on dbo.Contacts,
	add filter predicate security.TenantAndStatusPredicate(TenantId, ContactRowStatus) on dbo.Contacts,
	--add block predicate security.TenantAndStatusPredicate(TenantId, CreativeBlastCreativeTrackerRowStatus) on dbo.CreativeBlastTrackers,
	add filter predicate security.TenantAndStatusPredicate(TenantId, CreativeBlastCreativeTrackerRowStatus) on dbo.CreativeBlastTrackers,
	--add block predicate security.TenantAndStatusPredicate(TenantId, CreativesRowStatus) on dbo.Creatives,
	add filter predicate security.TenantAndStatusPredicate(TenantId, CreativesRowStatus) on dbo.Creatives,
	...
	--add block predicate security.TenantAndStatusPredicate(TenantId, CommunicationBlastRowStatus) on dbo.ZCommunicationBlasts,
	add filter predicate security.TenantAndStatusPredicate(TenantId, CommunicationBlastRowStatus) on dbo.ZCommunicationBlasts,
