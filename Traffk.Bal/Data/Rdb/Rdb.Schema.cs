...
// This was autogenerated using Rdb.Schema.tt and C:\src\traffk\Repos\HealthInformationPortal\Traffk.Bal\Data\Rdb\Rdb.Meta.xml at 12/14/2016 15:04:23
...
namespace Traffk.Bal.Data.Rdb
{
    public partial class TraffkRdbContext
    {
		...
		public DbSet<CreativeBlastTracker> CreativeBlastTrackers { get; set; }
		...
		public DbSet<ZCommunicationBlast> ZCommunicationBlasts { get; set; }
		...
		public async Task<ConnectionHelpers.Result<Job>> JobDequeueAsync(string jobType = null, string serviceRoleMachineName = null, int? numUnits = null, int? jobId = null, int? tenantId = null, int? maxConcurrentPerTenant = null) 
		{
            var ps = new SqlParameter[]
                {
                    new SqlParameter("@jobType", jobType==null ? DBNull.Value:(object) jobType){Direction=ParameterDirection.Input},
	...
	public partial class Application : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
		...
		[JsonIgnore]
        [IgnoreDataMember]
        public List<SystemCommunication> ApplicationSystemCommunications { get; set; } = new List<SystemCommunication>();
		...
		public Application(Application other)
		{
			if (other!=null)
			{
				ApplicationSystemCommunications = other.ApplicationSystemCommunications;
	...
	public partial class CommunicationBlast : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
		...
		[JsonIgnore]
        [IgnoreDataMember]
        public List<CreativeBlastTracker> CommunicationBlastCreativeBlastTrackers { get; set; } = new List<CreativeBlastTracker>();
		...
		public CommunicationBlast(CommunicationBlast other)
		{
			if (other!=null)
			{
				CommunicationBlastCreativeBlastTrackers = other.CommunicationBlastCreativeBlastTrackers;
	...
	public partial class CommunicationPiece : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
		...
		public byte[] CommunicationPieceUid { get; set; }
	...
	public partial class CommunicationPieceVisit : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
		...
		[DisplayName("Creative Blast Tracker Id")]
		[Column("CreativeBlastTrackerId")]
		public int CreativeBlastTrackerId { get; set; }

		[ForeignKey("CreativeBlastTrackerId")]
		[JsonIgnore]
        [IgnoreDataMember]
		public CreativeBlastTracker CreativeBlastTracker { get; set; }
		...
		public CommunicationPieceVisit(CommunicationPieceVisit other)
		{
			if (other!=null)
			{
				...
				CreatedAtUtc = other.CreatedAtUtc;
				CommunicationPieceId = other.CommunicationPieceId;
				CreativeBlastTrackerId = other.CreativeBlastTrackerId;
			}
			OnConstructed();
		}
	...
	public partial class Communication : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
		...
		public Communication(Communication other)
		{
			if (other!=null)
			{
				...
				CreativeId = other.CreativeId;
				CommunicationSettings = other.CommunicationSettings;
			}
			OnConstructed();
		}
	...
	/// </summary>
	[Table("CreativeBlastTrackers", Schema = "dbo")]
	public partial class CreativeBlastTracker : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
        public static readonly CreativeBlastTracker[] None = new CreativeBlastTracker[0];

		[InverseProperty("CreativeBlastTracker")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<CommunicationPieceVisit> CreativeBlastTrackerCommunicationPieceVisits { get; set; } = new List<CommunicationPieceVisit>();
		...
		[Column("TrackerUid")]
		public byte[] TrackerUid { get; set; }
        ...
        public override string ToString()
		{
			string extras = null;
			OnToString(ref extras);
			return $"{GetType().Name} CreativeBlastTrackerId={CreativeBlastTrackerId} {extras}";
		}

		partial void OnConstructed();
	
		public CreativeBlastTracker()
			: this(null)
		{}

		public CreativeBlastTracker(CreativeBlastTracker other)
		{
			if (other!=null)
			{
				CreativeBlastTrackerCommunicationPieceVisits = other.CreativeBlastTrackerCommunicationPieceVisits;
				CreativeBlastTrackerId = other.CreativeBlastTrackerId;
				TenantId = other.TenantId;
				CommunicationBlastId = other.CommunicationBlastId;
		...
		public virtual void Validate()
        {
			Requires.NonNull(LinkType, nameof(LinkType));
			Requires.Text(LinkType, nameof(LinkType), true, 0, 80);
	...
	public partial class Creative : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
		...
		public string TemplateEngineType { get; set; }
		...
		public Creative(Creative other)
		{
			if (other!=null)
			{
				...
				TemplateEngineType = other.TemplateEngineType;
				CreativeSettings = other.CreativeSettings;
			}
			OnConstructed();
		}
		...
		public virtual void Validate()
        {
			...
			Requires.Text(ModelType, nameof(ModelType), true, 0, 80);
			Requires.NonNull(TemplateEngineType, nameof(TemplateEngineType));
			Requires.Text(TemplateEngineType, nameof(TemplateEngineType), true, 0, 80);
			PartialValidate();
        }
	}
	...
	public partial class DateDimension : IRdbDataEntity, IValidate, IPreSave
	{
		...
		public virtual void Validate()
        {
			...
			Requires.Text(FiscalYearName, nameof(FiscalYearName), true, 0, 16);
			Requires.NonNull(FiscalQuarterName, nameof(FiscalQuarterName));
			Requires.Text(FiscalQuarterName, nameof(FiscalQuarterName), true, 0, 16);
			PartialValidate();
        }
	}
	...
	public partial class Job : IRdbDataEntity, IValidate, IPreSave
	{
		...
		[JsonIgnore]
        [IgnoreDataMember]
        public List<ZCommunicationBlast> JobZCommunicationBlasts { get; set; } = new List<ZCommunicationBlast>();
		...
		public Job(Job other)
		{
			if (other!=null)
			{
				JobZCommunicationBlasts = other.JobZCommunicationBlasts;
		...
		public virtual void Validate()
        {
			Requires.NonNull(JobType, nameof(JobType));
			Requires.Text(JobType, nameof(JobType), true, 0, 80);
			Requires.NonNull(JobStatus, nameof(JobStatus));
			Requires.Text(JobStatus, nameof(JobStatus), true, 0, 80);
	...
	public partial class MessageTemplate : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
        public static readonly MessageTemplate[] None = new MessageTemplate[0];

		[InverseProperty("MessageTemplate")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<SystemCommunication> MessageTemplateSystemCommunications { get; set; } = new List<SystemCommunication>();

		[InverseProperty("MessageTemplate")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<ZCommunicationBlast> MessageTemplateZCommunicationBlasts { get; set; } = new List<ZCommunicationBlast>();
		...
		[DisplayName("Message Template Title")]
		[NotNull]
		[Required]
		[MaxLength(255)]
		[Column("MessageTemplateTitle")]
		...
		[ForeignKey("SubjectTemplateId")]
		[JsonIgnore]
        [IgnoreDataMember]
		public Template SubjectTemplate { get; set; }

		[DisplayName("Html Body Template Id")]
		[Column("HtmlBodyTemplateId")]
		public int? HtmlBodyTemplateId { get; set; }

		[ForeignKey("HtmlBodyTemplateId")]
		[JsonIgnore]
        [IgnoreDataMember]
		public Template HtmlBodyTemplate { get; set; }

		[DisplayName("Text Body Template Id")]
		[Column("TextBodyTemplateId")]
		public int? TextBodyTemplateId { get; set; }

		[ForeignKey("TextBodyTemplateId")]
		[JsonIgnore]
        [IgnoreDataMember]
		public Template TextBodyTemplate { get; set; }
        ...
        public override string ToString()
		{
			string extras = null;
			OnToString(ref extras);
			return $"{GetType().Name} MessageTemplateId={MessageTemplateId} {extras}";
		}
		...
		public MessageTemplate(MessageTemplate other)
		{
			if (other!=null)
			{
				MessageTemplateSystemCommunications = other.MessageTemplateSystemCommunications;
				MessageTemplateZCommunicationBlasts = other.MessageTemplateZCommunicationBlasts;
				MessageTemplateId = other.MessageTemplateId;
				TenantId = other.TenantId;
				CreatedAtUtc = other.CreatedAtUtc;
				MessageTemplateTitle = other.MessageTemplateTitle;
				SubjectTemplateId = other.SubjectTemplateId;
				HtmlBodyTemplateId = other.HtmlBodyTemplateId;
				TextBodyTemplateId = other.TextBodyTemplateId;
			}
			OnConstructed();
		}
		...
		public virtual void Validate()
        {
			Requires.NonNull(MessageTemplateTitle, nameof(MessageTemplateTitle));
			Requires.Text(MessageTemplateTitle, nameof(MessageTemplateTitle), true, 0, 255);
			PartialValidate();
        }
	}
	...
	[Table("SystemCommunications", Schema = "dbo")]
	public partial class SystemCommunication : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
        public static readonly SystemCommunication[] None = new SystemCommunication[0];

		[DisplayName("System Communication Id")]
		[Key]
		[DatabaseGenerated(DatabaseGeneratedOption.Identity)]
		...
		[DisplayName("Communication Purpose")]
		[NotNull]
		[Required]
		[MaxLength(80)]
		[Column("CommunicationPurpose")]
		public string CommunicationPurpose { get; set; }

		[DisplayName("Communication Medium")]
		[NotNull]
		[Required]
		[MaxLength(80)]
		[Column("CommunicationMedium")]
        ...
        public override string ToString()
		{
			string extras = null;
			OnToString(ref extras);
			return $"{GetType().Name} SystemCommunicationId={SystemCommunicationId} {extras}";
		}

		partial void OnConstructed();
	
		public SystemCommunication()
			: this(null)
		{}

		public SystemCommunication(SystemCommunication other)
		{
			if (other!=null)
			{
				SystemCommunicationId = other.SystemCommunicationId;
				TenantId = other.TenantId;
				ApplicationId = other.ApplicationId;
				CommunicationPurpose = other.CommunicationPurpose;
				CommunicationMedium = other.CommunicationMedium;
				MessageTemplateId = other.MessageTemplateId;
			}
			OnConstructed();
		}
		...
		public virtual void Validate()
        {
			Requires.NonNull(CommunicationPurpose, nameof(CommunicationPurpose));
			Requires.Text(CommunicationPurpose, nameof(CommunicationPurpose), true, 0, 80);
			Requires.NonNull(CommunicationMedium, nameof(CommunicationMedium));
			Requires.Text(CommunicationMedium, nameof(CommunicationMedium), true, 0, 80);
			PartialValidate();
        }
	}

	[Table("Templates", Schema = "dbo")]
	public partial class Template : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
        public static readonly Template[] None = new Template[0];

		[InverseProperty("SubjectTemplate")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<MessageTemplate> SubjectTemplateMessageTemplates { get; set; } = new List<MessageTemplate>();

		[InverseProperty("HtmlBodyTemplate")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<MessageTemplate> HtmlBodyTemplateMessageTemplates { get; set; } = new List<MessageTemplate>();

		[InverseProperty("TextBodyTemplate")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<MessageTemplate> TextBodyTemplateMessageTemplates { get; set; } = new List<MessageTemplate>();
        ...
        public override string ToString()
		{
			string extras = null;
			OnToString(ref extras);
			return $"{GetType().Name} TemplateId={TemplateId} {extras}";
		}
		...
		public Template(Template other)
		{
			if (other!=null)
			{
				SubjectTemplateMessageTemplates = other.SubjectTemplateMessageTemplates;
				HtmlBodyTemplateMessageTemplates = other.HtmlBodyTemplateMessageTemplates;
				TextBodyTemplateMessageTemplates = other.TextBodyTemplateMessageTemplates;
		...
		public virtual void Validate()
        {
			Requires.Text(TemplateName, nameof(TemplateName), true, 0, 80);
			Requires.Text(ModelType, nameof(ModelType), true, 0, 80);
			Requires.NonNull(TemplateEngineType, nameof(TemplateEngineType));
			Requires.Text(TemplateEngineType, nameof(TemplateEngineType), true, 0, 80);
			PartialValidate();
	...
	public partial class Tenant : IRdbDataEntity, IValidate, IPreSave
	{
		...
		[JsonIgnore]
        [IgnoreDataMember]
        public List<SystemCommunication> TenantSystemCommunications { get; set; } = new List<SystemCommunication>();
		...
		[JsonIgnore]
        [IgnoreDataMember]
        public List<CreativeBlastTracker> TenantCreativeBlastTrackers { get; set; } = new List<CreativeBlastTracker>();
		...
		[JsonIgnore]
        [IgnoreDataMember]
        public List<ZCommunicationBlast> TenantZCommunicationBlasts { get; set; } = new List<ZCommunicationBlast>();
		...
		[JsonIgnore]
        [IgnoreDataMember]
        public List<Template> TenantTemplates { get; set; } = new List<Template>();

		[InverseProperty("Tenant")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<MessageTemplate> TenantMessageTemplates { get; set; } = new List<MessageTemplate>();
		...
		public Tenant(Tenant other)
		{
			if (other!=null)
			{
				TenantSystemCommunications = other.TenantSystemCommunications;
				...
				TenantCreativeBlastTrackers = other.TenantCreativeBlastTrackers;
				TenantCommunicationPieces = other.TenantCommunicationPieces;
				TenantZCommunicationBlasts = other.TenantZCommunicationBlasts;
				...
				TenantTemplates = other.TenantTemplates;
				TenantMessageTemplates = other.TenantMessageTemplates;
				TenantId = other.TenantId;
				ParentTenantId = other.ParentTenantId;
				CreatedAtUtc = other.CreatedAtUtc;
				TenantName = other.TenantName;
				LoginDomain = other.LoginDomain;
				TenantSettings = other.TenantSettings;
			}
			OnConstructed();
		}
	...
	[Table("ZCommunicationBlasts", Schema = "dbo")]
	public partial class ZCommunicationBlast : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
        public static readonly ZCommunicationBlast[] None = new ZCommunicationBlast[0];

		[InverseProperty("ParentCommunicationBlast")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<ZCommunicationBlast> ParentCommunicationBlastZCommunicationBlasts { get; set; } = new List<ZCommunicationBlast>();
		...
		[DisplayName("Parent Communication Blast Id")]
		[Column("ParentCommunicationBlastId")]
		public int? ParentCommunicationBlastId { get; set; }

		[ForeignKey("ParentCommunicationBlastId")]
		[JsonIgnore]
        [IgnoreDataMember]
		public ZCommunicationBlast ParentCommunicationBlast { get; set; }
		...
		[DisplayName("Communication Blast Title")]
		[NotNull]
		[Required]
		[MaxLength(255)]
		[Column("CommunicationBlastTitle")]
		public string CommunicationBlastTitle { get; set; }
		...
		partial void OnCommunicationBlastSettingsDeserialized();

        [NotMapped]
        public Bal.Settings.CommunicationSettings CommunicationBlastSettings
        {
            get
            {
                if (CommunicationBlastSettings_p == null)
                {
                    CommunicationBlastSettings_p = Bal.Settings.CommunicationSettings.CreateFromJson(CommunicationBlastSettingsJson) ?? new Bal.Settings.CommunicationSettings();
					OnCommunicationBlastSettingsDeserialized();
                }
                return CommunicationBlastSettings_p;
            }
            set { CommunicationBlastSettings_p = value; }
        }
        private Bal.Settings.CommunicationSettings CommunicationBlastSettings_p;

		[DisplayName("Communication Blast Settings")]
		[Column("CommunicationBlastSettings")]
		public string CommunicationBlastSettingsJson { get; set; }
		...
		public ZCommunicationBlast()
			: this(null)
		{}

		public ZCommunicationBlast(ZCommunicationBlast other)
		{
			if (other!=null)
			{
				ParentCommunicationBlastZCommunicationBlasts = other.ParentCommunicationBlastZCommunicationBlasts;
				CommunicationBlastId = other.CommunicationBlastId;
				ParentCommunicationBlastId = other.ParentCommunicationBlastId;
				TenantId = other.TenantId;
				CreatedAtUtc = other.CreatedAtUtc;
				JobId = other.JobId;
				CommunicationBlastTitle = other.CommunicationBlastTitle;
				CommunicationMedium = other.CommunicationMedium;
				TopicName = other.TopicName;
				CampaignName = other.CampaignName;
				MessageTemplateId = other.MessageTemplateId;
				CommunicationBlastSettings = other.CommunicationBlastSettings;
			}
			OnConstructed();
		}
		...
		protected virtual void OnPreSave()
		{
            if (CommunicationBlastSettings_p != null)
            {
				var json = CommunicationBlastSettings_p.ToJson();
				if (CommunicationBlastSettingsJson != json)
				{
					CommunicationBlastSettingsJson = json;
				}				 
            }
			PartialPreSave();
        }
		...
		public virtual void Validate()
        {
			Requires.NonNull(CommunicationBlastTitle, nameof(CommunicationBlastTitle));
			Requires.Text(CommunicationBlastTitle, nameof(CommunicationBlastTitle), true, 0, 255);
			Requires.NonNull(CommunicationMedium, nameof(CommunicationMedium));
			Requires.Text(CommunicationMedium, nameof(CommunicationMedium), true, 0, 80);
			Requires.Text(TopicName, nameof(TopicName), true, 0, 255);
			Requires.Text(CampaignName, nameof(CampaignName), true, 0, 255);
