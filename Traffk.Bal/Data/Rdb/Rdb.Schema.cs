// This was autogenerated using Rdb.Schema.tt and C:\src\traffk\Repos\HealthInformationPortal\Traffk.Bal\Data\Rdb\Rdb.Meta.xml at 12/05/2016 00:35:11
...
namespace Traffk.Bal.Data.Rdb
{
    public partial class TraffkRdbContext
    {
		...
		public DbSet<CommunicationBlastLink> CommunicationBlastLinks { get; set; }
	...
	public partial class Application : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
		...
		[DisplayName("Foreign key to the tenant that owns this account")]
		[Column("TenantId")]
		...
		[DisplayName("Human readible name of the application")]
		[NotNull]
		[Required]
		[MaxLength(255)]
		...
		[DisplayName("Settings particular to this type of application")]
	...
	[Table("CommunicationBlastLinks", Schema = "dbo")]
	public partial class CommunicationBlastLink : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
        public static readonly CommunicationBlastLink[] None = new CommunicationBlastLink[0];

		[Key]
		[DatabaseGenerated(DatabaseGeneratedOption.Identity)]
		[Column("CommunicationBlastLinkId")]
		public int CommunicationBlastLinkId { get; set; }
        ...
        public override string ToString()
		{
			string extras = null;
			OnToString(ref extras);
			return $"{GetType().Name} CommunicationBlastLinkId={CommunicationBlastLinkId} {extras}";
		}

		partial void OnConstructed();
	
		public CommunicationBlastLink()
			: this(null)
		{}

		public CommunicationBlastLink(CommunicationBlastLink other)
		{
			if (other!=null)
			{
				CommunicationBlastLinkId = other.CommunicationBlastLinkId;
				CommunicationBlastId = other.CommunicationBlastId;
				TenantId = other.TenantId;
				LinkType = other.LinkType;
				MungedPathAndQuery = other.MungedPathAndQuery;
		...
		public virtual void Validate()
        {
			...
			Requires.NonNull(MungedPathAndQuery, nameof(MungedPathAndQuery));
			Requires.Text(MungedPathAndQuery, nameof(MungedPathAndQuery), true, 0, 255);
			Requires.NonNull(RedirectUrl, nameof(RedirectUrl));
			Requires.Text(RedirectUrl, nameof(RedirectUrl), true, 0, 1024);
			Requires.NonNull(CommunicationFormat, nameof(CommunicationFormat));
			Requires.Text(CommunicationFormat, nameof(CommunicationFormat), true, 0, 80);
			PartialValidate();
        }
	}
	...
	public partial class CommunicationBlast : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
		...
		[JsonIgnore]
        [IgnoreDataMember]
        public List<CommunicationBlast> ParentCommunicationBlastCommunicationBlasts { get; set; } = new List<CommunicationBlast>();

		[InverseProperty("CommunicationBlast")]
		[JsonIgnore]
        [IgnoreDataMember]
        public List<CommunicationBlastLink> CommunicationBlastCommunicationBlastLinks { get; set; } = new List<CommunicationBlastLink>();
		...
		[JsonIgnore]
        [IgnoreDataMember]
		public CommunicationBlast ParentCommunicationBlast { get; set; }
		...
		[DisplayName("Datetime when this entity was created.")]
        ...
        [NotMapped]
        public Bal.Settings.CommunicationBlastSettings CommunicationBlastSettings
        {
            get
            {
                if (CommunicationBlastSettings_p == null)
                {
                    CommunicationBlastSettings_p = Bal.Settings.CommunicationBlastSettings.CreateFromJson(CommunicationBlastSettingsJson) ?? new Bal.Settings.CommunicationBlastSettings();
        ...
        private Bal.Settings.CommunicationBlastSettings CommunicationBlastSettings_p;
		...
		public CommunicationBlast(CommunicationBlast other)
		{
			if (other!=null)
			{
				ParentCommunicationBlastCommunicationBlasts = other.ParentCommunicationBlastCommunicationBlasts;
				CommunicationBlastCommunicationBlastLinks = other.CommunicationBlastCommunicationBlastLinks;
				CommunicationBlastId = other.CommunicationBlastId;
	...
	public partial class MessageTemplate : IRdbDataEntity, IValidate, IPreSave, ITraffkTenanted
	{
		...
		[JsonIgnore]
        [IgnoreDataMember]
        public List<CommunicationBlast> MessageTemplateCommunicationBlasts { get; set; } = new List<CommunicationBlast>();
		...
		public MessageTemplate(MessageTemplate other)
		{
			if (other!=null)
			{
				...
				MessageTemplateCommunicationBlasts = other.MessageTemplateCommunicationBlasts;
				MessageTemplateId = other.MessageTemplateId;
				TenantId = other.TenantId;
				CreatedAtUtc = other.CreatedAtUtc;
	...
	public partial class Tenant : IRdbDataEntity, IValidate, IPreSave
	{
		...
		[JsonIgnore]
        [IgnoreDataMember]
        public List<CommunicationBlastLink> TenantCommunicationBlastLinks { get; set; } = new List<CommunicationBlastLink>();
		...
		public Tenant(Tenant other)
		{
			if (other!=null)
			{
				...
				TenantCommunicationBlastLinks = other.TenantCommunicationBlastLinks;
