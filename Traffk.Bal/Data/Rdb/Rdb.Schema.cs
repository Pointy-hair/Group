// This was autogenerated using Rdb.Schema.tt and C:\src\rs\Main\all\TraffkBal\Data\Rdb\Rdb.Meta.xml at 11/30/2016 00:23:51
...
namespace Traffk.Bal.Data.Rdb
{
    public partial class TraffkRdbContext
    {
		...
		public DbSet<PersonZ> People { get; set; }
	...
	[Table("Contacts", Schema = "dbo")]
	public partial class PersonZ : Contact
	{
        public static new readonly PersonZ[] None = new PersonZ[0];
	...
	public partial class Tenant : IRdbDataEntity, IValidate, IPreSave
	{
		...
		public virtual void Validate()
        {
			...
			Requires.NonNull(TenantStatus, nameof(TenantStatus));
			Requires.Text(TenantStatus, nameof(TenantStatus), true, 0, 80);
			PartialValidate();
        }
	}
